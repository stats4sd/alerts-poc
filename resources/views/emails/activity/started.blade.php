...
Activcity Started At: <b>{{ $alert->created_at }}</b>
@endcomponent

It can also include links based on the triggering activity:

@component('mail::button', ['url' => 'https://mesh-alerts.stats4sdtest.online/admin/activity/'.$activity->id.'/show', 'color' => 'success'])
